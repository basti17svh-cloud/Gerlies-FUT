...
test('walkout travels through nation, position and club before revealing the player',async()=>{
 ...
 for(const id of ['opening','openPackBtn','openStage','bigPack','packCountdown','flash','walkoutTunnel','walkoutClue','reveal','revealBadge','revealCard','revealSecondCard','walkoutTitle','results'])elements.set(id,element(id));
